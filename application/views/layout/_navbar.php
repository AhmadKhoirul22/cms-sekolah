<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
	<a href="<?= base_url('home') ?>" class="navbar-brand p-0 mt-3">
		<div class="d-flex">
			<img src="<?= base_url('assets/upload/icon/logo.png') ?>" alt="">
			<h5 class="text-primary justify-content-start"></i><?=$profile->nama_profile ?></h5>
		</div>
		<!-- <div class="row">
			<div class="col-3">
	...
	<div class="collapse navbar-collapse" id="navbarCollapse">
		...
		<div class="navbar-nav ms-auto py-0">
			<a href="<?= base_url('home') ?>"
				...
				<a href="<?= base_url('ppdb_f') ?>"
				class="nav-item nav-link <?php if($menu == 'ppdb_f'){echo 'active';} ?>">PPDB</a>
			...
			<a href="<?= base_url('artikel') ?>" class="nav-item nav-link <?php if($menu == 'artikel'){echo 'active';} ?>">Artikel</a>
