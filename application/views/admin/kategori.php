						  ...
						  <table class="table DataTable" id="table1" >
							...
							<tbody>
								...
								<tr>
									...
									<a href="<?= base_url('admin/kategori/delete/'.$row['id_kategori']) ?>" class="btn btn-danger delete-button"
									data-href="<?= base_url('admin/kategori/delete/'.$row['id_kategori']) ?>"
									><i class="bi bi-trash"></i></a>
									</td>
								</tr>
														<!-- modal -->
														<div class="modal fade text-left" id="default<?= $row['id_kategori'] ?>" tabindex="-1" aria-labelledby="myModalLabel1"
