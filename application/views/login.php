...
<head>
	...
	<link rel="stylesheet"
		href="<?= base_url('assets/mazer/dist/') ?>assets/vendors/bootstrap-icons/bootstrap-icons.css">
	...
	<div id="auth">
		...
		<div class="row h-100">
			<div class="col-lg-5 col-12">
				<div id="auth-left">
					<div class="auth-logo">
						<a href="<?= base_url('auth') ?>"><img
								src="<?= base_url('assets/mazer/dist/') ?>assets/images/logo/logo.png" alt="Logo"></a>
					</div>
