                    ...
                    <div class="card">
                        <div class="card-body">
							...
							<form action="<?= base_url('admin/profile/update') ?>" method="post" >
								...
								<div class="mb-3">
								<label for="" class="form-label">Alamat Profile</label>
								<input type="text" name="alamat_profile" value="<?= $profile->alamat_profile ?>" class="form-control">
								</div>
								<div class="mb-3">
								<label for="" class="form-label">Keterangan Profile</label>
								<textarea name="keterangan_profile" class="form-control" id="dark"><?= $profile->keterangan_profile ?></textarea>
								</div>
								<div class="mb-3">
