                            ...
                            <div class="row gy-0 gx-5">
                                ...
                                <div class="col-xl-7 animated fadeInLeft">
                                    <div class="text-sm-center text-md-end">
                                        <h5 class="text-primary fw-bold mb-4"><?= $profile->nama_profile ?></h5>
                                        <!-- <h6 class="display-4 text-white mb-4"><?= $profile->keterangan_profile ?></h6> -->
                                        <p class="mb-5 fs-5"> <?= $profile->keterangan_profile ?> 
                                        </p>
                            ...
                            <div class="row g-5">
                                <div class="col-12 animated fadeInUp">
                                    <div class="text-center">
                                        <h4 class="text-primary text-uppercase fw-bold mb-4"><?= $profile->nama_profile ?></h4>
                                        <!-- <h1 class="display-4 text-uppercase text-white mb-4"><?= $profile->keterangan_profile ?></h1> -->
                                        <p class="mb-5 fs-5"><?= $profile->keterangan_profile ?> 
                                        </p>
